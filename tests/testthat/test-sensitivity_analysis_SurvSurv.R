test_that("ica_SurvSurv_sens() works on a single core", {
  data("Ovarian")
...
# test_that("ica_SurvSurv_sens() works on 2 cores", {
#   library(Surrogate)
#   data("Ovarian")
#   # For simplicity, data is not recoded to semi-competing risks format, but the
#   # data are left in the composite event format.
...
#   # Illustration with small number of replications and low precision
#   set.seed(1)
#   sens_results = Surrogate:::sensitivity_analysis_SurvSurv_copula(
#     ovarian_fitted,
#     composite = TRUE,
#     cond_ind = TRUE,
#     n_sim = 5,
