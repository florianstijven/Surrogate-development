...
\format{
  ...
  \describe{
    ...
    \item{\code{responder}}{Binary tumor response (the candidate surrogate), coded as 1=complete response (CR) or partial response (PR) and 0=stabled disease (SD) or progressive disease (PD).}
